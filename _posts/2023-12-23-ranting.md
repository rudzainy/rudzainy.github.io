...
![Number (estimates) of internet users in Malaysia from 2014-2029](/assets/img/posts/ranting/number-of-internet-users-in-Malaysia-2014-2029.png)
...
I imagined Ranting to be a straight forward [Linktree](https://linktr.ee) clone.
...
{% responsive_image path: assets/img/posts/ranting/concept.png alt: "Initial concept for Ranting." %}
_Initial concept for Ranting._

### Branding

I have a background doing digital graphic designs. When I approached what to work on for branding, I immediately went for the default style of Bootstrap. I took direct inspiration for the logo from Bootstrap's logo. I also use Bootstrap's colours as Ranting's default colour scheme.
...
So i bought another domain, and Ranting is now officially [Gugel](https://gugel.my)! 🥳
...
Building the drag and drop feature and fine tuning them to behave exactly how I want takes more effort than I anticipated. Therefore for version 1.0.0 and until 1.1.0, Ranting will focus to deliver simple and practical UI. 
