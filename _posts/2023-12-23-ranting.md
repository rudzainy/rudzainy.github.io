...
In early 2023, I was researching ideas to build an online platform (SaaS) providing services to Malaysian. This is a how that story is going so far.
...
{% responsive_image path: assets/img/posts/ranting/Screenshot_2024-05-02_at_8-50-03_AM.png alt: "Timeline of mobile cellular service adoption in Malaysia, with 3G expansion giving access to the internet through people's fingertips – MCMC." %}
_Timeline of mobile cellular service adoption in Malaysia, with 3G expansion giving access to the internet through people's fingertips – MCMC._
...
in June 2021, the Government of Malaysia approved the recognition of _communications as a public utility_, after water and electricity.
...
I imagined Ranting to be a straight forward [Linktree](https://linktr.ee) clone. Comodatising links will be the core consideration when considering any features to build.
...
Considering future expansions, I introduced a Groups table as a mean to manage links.
...
I have a background doing digital graphic designs. When I approached what to work on for Ranting's branding, I immediately went for the default style of Bootstrap. I took direct inspiration for the logo from Bootstrap's logo. I also use Bootstrap's colours as Ranting's default colour scheme.
...
1. Re-purpose my old project's domain [hoojah.my](/posts/the-hoojah-project).
1. Use a domain I owned called vayl.my (roughly translate to _doorway_ in Tamil).
...
{% responsive_image path: assets/img/posts/ranting/Login-Mobile.png alt: "Design of mobile login page." %}
_Design of mobile login page._
