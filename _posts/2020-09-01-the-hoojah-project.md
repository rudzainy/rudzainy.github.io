...
{% picture assets/img/posts/hoojah/Home-User.png --alt Home page showing timeline view of recently updated polls. Desktop users would be able to see additional information in the left and right sidebars. %}
...
{% picture assets/img/posts/hoojah/User-Show-Votes.png --alt User profile page showing all participated (and possibly trending or promoted) polls by the user. %}
...
{% picture assets/img/posts/hoojah/Poll-Show-User.png --alt A poll page, illustrating three main interactions a user can engage with a poll. Users can vote, add supporting arguments under each vote option independently of their personal vote, as well as engage in a one-on-one debate with another user. %}
...
{% picture assets/img/posts/hoojah/Debate-Show-Ended.png --alt A one-on-one debate page (seems to be getting good traction, probably because of the two well known public figure debating... interesting stuff). %}
...
{% picture assets/img/posts/hoojah/Business-Search.png --alt Analytic page for business tier users. %}
_Analytic page for business tier users._

{% picture assets/img/posts/hoojah/Log-In.png --alt The log in and sign up feature is combined into a single page. Log in takes priority over sign up, therefore on mobile, the sign up form would be pushed down. %}
...
{% picture assets/img/posts/hoojah/Poll-New.png --alt Registered users can create new polls with some options for customization. %}
_Registered users can create new polls with some options for customization._

{% picture assets/img/posts/hoojah/User-Show-Polls.png --alt Alternative design of user profile page with badges. The idea for badges came from the need to group user interests together, where a badge could be affiliated with user groups, active categories or user achievements. %}
